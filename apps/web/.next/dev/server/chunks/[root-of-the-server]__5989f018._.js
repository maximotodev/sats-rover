...
"[project]/apps/web/src/app/api/merchants/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (!rawBbox) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$28$2e$6_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Missing bbox"
    }, {
        status: 400
    });
    ...
    const bbox = rawBbox.split(",").map((coord)=>Number(coord).toFixed(3)).join(",");
    const query = `
    [out:json][timeout:25];
    (
  ...
  `;
    try {
        ...
        const merchants = data.elements.map((el)=>({
                id: el.id.toString(),
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$28$2e$6_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            data: [],
            error: "Upstream API slow",
            details: error.message
        }, {
            status: 200
        } // Return 200 with empty data to prevent UI errors
        );
    }
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5989f018._.js.map